...
namespace Kafe_Restorant_Yonetim_Sistemi
{
    public partial class frmSatislar : Form
    {
        ...
        private void gridSatislar_Click(object sender, DataGridViewCellEventArgs e)
        {
            ...
            gridSatisDetayUrun.Columns[0].Visible = true;
            gridSatisDetayUrun.Columns[1].Visible = true; ;
        }
