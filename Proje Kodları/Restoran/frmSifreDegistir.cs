...
namespace Kafe_Restorant_Yonetim_Sistemi
{
    public partial class frmSifreDegistir : Form
    {
        ...
        private void btnDegistir_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!kontroller.kullaniciKontrolu(frmGiris.kulAdi, Islemler.dondur(txtEskiSifre.Text)))
                {
                ...
                else
                {
                    ...
                    {
                        if (Kullanici.KullaniciSifreDegistir(frmGiris.kulAdi, Islemler.dondur(txtYeniSifre.Text)))
                        {
